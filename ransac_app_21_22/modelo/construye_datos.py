...
def construye_datos(rng=np.random.RandomState()):
    ...
    segmento_rand_1 = fig_aleat.segmento2d_en_rectangulo_rand(rectangulo_imagen,
                                                              num_inliers,
                                                              des_std=des_std,
                                                              distancia_minima=100.,
                                                              rng=rng)

    # Segmento aleatorio 2
    ratio_inliers = POR_RECTA  # Proporción sobre el total
    segmento_rand_2 = fig_aleat.segmento2d_en_rectangulo_rand(rectangulo_imagen, num_inliers,
                                                              des_std, 200., rng)

    # Segmento aleatorio 3
    ratio_inliers = POR_RECTA  # Proporción sobre el total
    segmento_rand_3 = fig_aleat.segmento2d_en_rectangulo_rand(rectangulo_imagen, num_inliers,
                                                              des_std, 300., rng)
    ...
    #---------------------------------------------------------------------------------------------------
    # Circunferencia aleatoria dentro del rectangulo
    ...
    num_puntos_imagen = num_puntos - (num_inliers*3+num_inliers*4+num_inliers_4)
    ...
    puntos = np.concatenate((segmento_rand_1['puntos'],
                             segmento_rand_2['puntos'],
                             segmento_rand_3['puntos'],
                             segmento_1,
                             segmento_2,
                             segmento_3,
                             segmento_4,
                             circunferencia_rand['puntos'],
                             nube_rectangulo_rand['puntos']),
                            axis=0)
    ...
    return {'imagen': nube_rectangulo_rand,
            'segmento': [segmento_rand_1, segmento_rand_2, segmento_rand_3],
