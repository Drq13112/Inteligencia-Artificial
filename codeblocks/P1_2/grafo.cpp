...
namespace grafo
{
    ...
    void elimina_elemento(std::vector<std::string> &v,const std::string &s)
{
    int tam = v.size();
    for (int i = 0; i < tam; i++) {
        if (s == v[i])
