...
namespace grafo
{
    ...
    class Grafo
    {
        ...
        //contructor por defecto
            ...
            void borrar_nodo(const std::string& s);
            void Crear_arista_dirigida(const std::string& s1, const std::string& s2);
            void Borrar_arista_dirigida(const std::string& s1, const std::string& s2);
            void Guardar_grafo(const std::string& nombre_fichero);
            void Crear_arista_no_dirigida(const std::string& s1, const std::string& s2);
            void Borrar_arista_no_dirigida(const std::string& s1, const std::string& s2);
            void Muestra_lista();
