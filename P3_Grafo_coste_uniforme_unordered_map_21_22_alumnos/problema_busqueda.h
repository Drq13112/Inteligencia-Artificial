...
namespace problema_busqueda
{
    ...
    template<typename Problema>
    using tipo_coste = typename Problema::tipo_coste;//Problema debe ser una clase o una estructura y por ende debe tener una variable tipo_coste
    //que es la variable a la que nos referimos
