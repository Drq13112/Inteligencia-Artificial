...
#include "../modelo/problema_busqueda.h"
#include "../modelo/nodo_cuadricula.h"
...
//  FUNCIONES DEL CONTROLADOR RELATIVAS AL MODELO
    // Deduce de la vista la posicion inicial en la cuadrícula del modelo
    ...
    // Deduce de la vista la posicion final en la cuadrícula del modelo
    ...
    // Vector con las posiciones de los obstáculos
    ...
    void Controlador::ejecuta_modelo()
    {
        ...
        auto solucion = problema_busqueda::coste_uniforme(nodo_inicial, nodo_objetivo);
