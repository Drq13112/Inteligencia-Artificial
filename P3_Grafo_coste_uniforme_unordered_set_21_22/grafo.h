...
namespace grafo
{
    ...
    class Grafo
    {
        ...
        private:
            // Se puede almacenar de forma más compacta, pero con esta programación logramos:
            std::map<tipo_nodo, std::vector<tipo_nodo>> nodos;           // --> rapido acceso a los vecinos
            std::map<tipo_nodo, std::map<tipo_nodo, tipo_coste>> costes; // --> rápido acceso a los costes
